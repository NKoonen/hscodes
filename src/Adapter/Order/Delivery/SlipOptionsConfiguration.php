...
namespace NKoonen\Module\Hscodes\Adapter\Order\Delivery;
...
final class SlipOptionsConfiguration implements DataConfigurationInterface
{
    ...
    public const LEGAL_FREE_TEXT = 'PS_SLIP_LEGAL_FREE_TEXT';
    ...
    public function getConfiguration()
    {
        return [
            ...
            'legal_free_text' => $this->configuration->get(self::LEGAL_FREE_TEXT),
        ];
    }
    ...
    public function updateConfiguration(array $configuration)
    {
        if ($this->validateConfiguration($configuration)) {
            ...
            $this->configuration->set(self::LEGAL_FREE_TEXT, $configuration['legal_free_text']);
        }
